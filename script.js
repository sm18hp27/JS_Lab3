function getWeather() {
    ...
    const apiKey = 'd647d8b530133f0943e73366693a5bfa'; // Replace with your actual API key
    const url = `https://api.openweathermap.org/data/3.0/weather?q=${cityInput}&appid=${apiKey}&units=metric`;
